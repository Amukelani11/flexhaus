        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-12 lg:px-16 py-16 bg-archive-charcoal text-archive-cream">
            ...
            <FadeIn delay={0.6} className="mt-8">
              <Link
                href="/products/prada-re-edition-2000-nylon"
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-8">
            {["Products", "About", "Cart"].map((item) => (
              <Link key={item} href={`/${item.toLowerCase()}`} className="font-mono text-[9px] uppercase tracking-[0.3em] text-archive-cream/30 hover:text-archive-terracotta transition-colors">
                {item}
              </Link>
            ))}
          </div>
