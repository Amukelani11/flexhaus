      ...
      <div className="max-w-[1200px] mx-auto px-8 py-10">
        {state.items.length === 0 ? (
          <div className="bg-gray-50 rounded-sm p-20 text-center">
            ...
            <Link href="/products" className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.3em] bg-flex-yellow px-6 py-3 hover:bg-flex-black hover:text-flex-yellow transition-colors">
              Browse the Drop
            </Link>
          </div>
        ) : (
