    ...
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/flex" className="font-display font-black text-2xl tracking-[-0.03em] uppercase select-none flex items-center text-flex-black">
            FLEX
      ...
      >
        <div className="absolute top-5 right-6">
          <button type="button" onClick={() => setMenuOpen(false)} className="border-2 border-flex-black p-2">
            <X size={18} />
          </button>
        </div>
        {["Products", "About"].map((item) => (
