      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        {state.items.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-6 py-32">
            ...
            <Link href="/products" className="text-[11px] tracking-[0.4em] uppercase text-noir-gold font-sans hover:underline">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              ...
              <Link href="/products" className="flex items-center gap-2 text-[10px] tracking-[0.35em] uppercase text-noir-ivory/30 font-sans hover:text-noir-gold transition-colors">
