  ...
  return (
    <div className="pt-24 min-h-screen">
      ...
      <div className="px-8 py-4 max-w-[1600px] mx-auto flex items-center gap-2 text-[10px] tracking-[0.3em] uppercase font-sans text-noir-ivory/30">
        <Link href="/" className="hover:text-noir-gold transition-colors">Home</Link>
        <ChevronRight size={10} />
        <Link href="/products" className="hover:text-noir-gold transition-colors">Collection</Link>
        <ChevronRight size={10} />
