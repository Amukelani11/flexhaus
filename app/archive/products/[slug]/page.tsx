    ...
    <div className="pt-16 min-h-screen">
      ...
      <div className="px-10 lg:px-16 py-4 border-b border-archive-line">
        <div className="max-w-[1400px] mx-auto flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.3em] text-archive-charcoal/40">
          <Link href="/archive" className="hover:text-archive-terracotta transition-colors">Home</Link>
          <ChevronRight size={9} />
          <Link href="/archive/products" className="hover:text-archive-terracotta transition-colors">Archive</Link>
          <ChevronRight size={9} />
          ...
          <div className="mt-24 pt-16 border-t border-archive-line">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {related.map((p, i) => (
                ...
                >
                  <TiltCard>
                    <Link href={`/archive/products/${p.slug}`} className="group block">
